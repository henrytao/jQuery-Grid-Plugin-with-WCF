function jqGridInclude()
{
    ...
    var modules = [
        ...
        {include: true, incfile: 'jqDnR.js', minfile: 'min/jqDnR-min.js' },
        { include: true, incfile: 'jqModal.js', minfile: 'min/jqModal-min.js' },
        { include: true, incfile: 'jquery.tablednd.js', minfile: 'min/jquery.tablednd-min.js' },
